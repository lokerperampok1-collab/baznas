...
<html lang="en-US">
<head>
	<title>@yield('title', 'KURBAN BERKAH BAZNAS | BAZNAS Kabupaten Tasikmalaya')</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0, user-scalable=0">
	<meta name="application-name" content="kurban"/>
	...
	<meta property="og:description" content="Kurban tidak harus mahal. Dengan Program Kurban Berkah BAZNAS, Anda bisa menunaikan ibadah qurban dengan harga terjangkau, tanpa mengurangi esensi dan keberkahan." />
	<meta property="og:image" content="{{ asset('uploads/2025/04/kurban-berkah-2.jpg') }}" />
	<meta property="twitter:card" content="summary_large_image">
	<meta property="twitter:title" content="KURBAN BERKAH BAZNAS">
	<meta property="twitter:description" content="Kurban tidak harus mahal. Dengan Program Kurban Berkah BAZNAS, Anda bisa menunaikan ibadah qurban dengan harga terjangkau, tanpa mengurangi esensi dan keberkahan.">
	<meta property="twitter:image" content="{{ asset('uploads/2025/04/kurban-berkah-2.jpg') }}" />
	
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/donasiaja5bf8.css?ver=2.2.5') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/donasiaja.css') }}">
...
<body>
	...
	<script src="{{ asset('assets/js/donasiaja.min5bf8.js?ver=2.2.5') }}"></script>
    <script src="{{ asset('assets/js/donasiaja.min.js') }}"></script>
